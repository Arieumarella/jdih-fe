...
<head>
    ...
    <link rel="stylesheet" href="<?= base_url() ?>internal/assets/plugins/datatables/jquery.dataTables.css">
    ...
    <script src="<?= base_url() ?>internal/assets/plugins/datatables/jquery.dataTables.js"></script>
...
<body>
    ...
    <header class="header-area fixed-con" style="background-color: #45678d;margin-top:0;box-shadow: 0 5px 15px rgba(0, 0, 0, 0.15); border-color: #45678d;font-size:12px;">
        <div align="right" style="color:#fff;margin-right:20px;height:3px;" class="mb-2 mt-2">
            <?php
                ...
                <div class="row">
                    <div class="col-12">
                        <nav class="navbar navbar-expand-lg ">
                            ...
                            <a class="navbar-brand" href="http://jdihn.go.id/">
                                <img src="<?php echo base_url(); ?>assets/img/core-img/logo_jdih_mini.png" alt="Logo" class="logo_jdih_mini" style="object-fit:cover">
                            </a>
                            <a class="navbar-brand" href="http://pu.go.id">
                                <img src="<?php echo base_url(); ?>assets/img/core-img/logo_pu_mini.png" alt="Logo" class="logo_pupr_mini">
                            </a> -->
                            ...
                            <div class="collapse navbar-collapse" id="worldNav">
                                <ul class="navbar-nav ml-auto">
                                    <li class="nav-item <?php if ($dataaktif == "home") {
                                        ...
                                        <a class="nav-link translatable" href="<?php echo base_url(); ?>">Beranda</a>
                                    </li>
                                    <li class="nav-item dropdown <?php if ($dataaktif == "produk_hukum") {
                                                                        echo "active";
                                                                    } ?>">
                                        <a class="nav-link dropdown-toggle translatable" href="<?php echo base_url(); ?>" id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Jenis Produk Hukum</a>
                                    ...
                                    $putusan_pengadilan = base_url("#");
                                    ?>
                                    <li class="nav-item dropdown  <?php if ($dataaktif == "informasi_hukum") {
                                                                        echo "active";
                                                                    } ?>">
                                        <a class="nav-link dropdown-toggle translatable" href="#" id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Informasi Hukum</a>
                                        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                                            <a class="dropdown-item" href="<?php echo base_url() ?>Monograf">Monografi</a>
                                            <a class="dropdown-item" href="<?php echo base_url() ?>Putusan">Putusan Pengadilan</a>
                                            <a class="dropdown-item" href="http://sisuper.pu.go.id/">Sisuper</a>
                                            <a class="dropdown-item" href="<?php echo base_url() ?>Berita">Berita</a>
                                            <a class="dropdown-item" href="<?php echo base_url() ?>Agenda">Agenda</a>
                                            <a class="dropdown-item" href="<?php echo base_url() ?>Konsultasipublik">Konsultasi Publik</a>
                                        </div>
                                    </li>

                                    <!-- <li class="nav-item dropdown  <?php if ($dataaktif == "SiMPeL") {
                                                                            echo "active";
                                                                        } ?>">
                                        <a class="nav-link dropdown-toggle translatable" href="#" id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">SiMPeL</a>
                                        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                                            <a class="dropdown-item" href="<?php echo base_url() ?>SiMPeL/getData/5">Prolegnas RUU Prioritas Tahunan</a>
                                            <a class="dropdown-item" href="<?php echo base_url() ?>SiMPeL/getData/1">Progsun PP/PERPRES</a>
                                            <a class="dropdown-item" href="<?php echo base_url() ?>SiMPeL/getData/2">PROLEG PUPR</a>
                                            <a class="dropdown-item" href="<?php echo base_url() ?>SiMPeL/getData/3">IP RPP/RPERPRES</a>
                                            <a class="dropdown-item" href="<?php echo base_url() ?>SiMPeL/getData/4">IP RPERMEN</a>
                                        </div>
                                    </li> -->
                                    ...
                                    <li class="nav-item  <?php if ($dataaktif == "statistik") {
                                        ...
                                        <a class="nav-link translatable" href="<?php echo base_url() ?>statistik">Statistik</a>
                                    </li>
                                    <li class="nav-item dropdown  <?php if ($dataaktif == "tentang_jdih") {
                                                                        echo "active";
                                                                    } ?>">
                                        <a class="nav-link dropdown-toggle translatable" href="#" id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Tentang JDIH</a>
                                        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                                    ...
                                    <li class="nav-item">
                                        <div class="nav-link font-weight-bold">
                                            <div class="btn-group">
                                                <button class="btn btn-sm btn-outline-light lang-button text-white" value="id" style="background-color: transparent;">ID</button>
                                                <button class="btn btn-sm btn-outline-light lang-button text-white" value="en" style="background-color: transparent;">EN</button>
                                            </div>
                                        </div>
                                    </li>
                                </ul>
