    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-12 col-lg-8" style="margin-bottom:10px;">
                ...
                <?php $this->load->view("widget/list_produk_terbaru"); ?>
                <?php $this->load->view("widget/list_berita"); ?>
                <?php $this->load->view("widget/list_infografis"); ?>
                <?php $this->load->view("widget/list_agenda"); ?>
                <?php $this->load->view("widget/rating"); ?>
                <?php $this->load->view("widget/tematik"); ?>
