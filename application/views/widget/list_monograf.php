...
$namaperaturan = '';
?>
<input type="hidden" id="tcari" value="<?php echo $tipe_dokumen; ?>">
        ...
        <div class="col-md-12" id="noperaturan-colomn" style="padding-bottom: 10px">
            <div class="row">
                <div class="col-md-6 text-bold">
                    <label style="color: #fff;margin-top:10px;margin-left:10px" class="translatable">Monografi</label>
                </div>
            </div>
        </div>
    </div>
