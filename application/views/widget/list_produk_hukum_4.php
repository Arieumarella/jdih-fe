                ...
                <div class="tab-pane fade show active" role="tabpanel" aria-labelledby="tab1" id="div_produk_hukum">
                    ...
                    <table class="table table-striped table-bordered">
                        <tr>
                            ...
                            <td width="70%">Putusan Pengadilan / Yurispudensi</td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            <td width="30%">Tempat Peradilan</td>
                            <td width="70%"><?php echo $hproduk['tempat_terbit']; ?></td>
                        </tr>

                        <tr>
                            <td width="30%">Tanggal Dibacakan</td>
                            <td width="70%"><?php echo substr($hproduk['tanggal_pengundangan'], 6, 2) . "/" . substr($hproduk['tanggal_pengundangan'], 4, 2) . "/" . substr($hproduk['tanggal_pengundangan'], 0, 4); ?></td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td width="70%">
                                ...
                                if (!empty($hproduk['file_abstrak'])) {
                                    echo anchor('produk_hukum/download_abstrak/putusan/' . $kodekat . '/' . $tahun . '/' . $bulan . '/' . $hproduk['file_abstrak'], '<i class="fa fa-download"></i> ' . $hproduk['file_abstrak'], 'target=_blank');
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td>
                                    ...
                                    ?>
                                        <a href="<?php echo base_url() ?>internal/assets/assets/produk/putusan/<?php echo $kodekat . "/" . $tahun . "/" . $bulan . "/" . $hproduk['file_upload']; ?>" class="btn btn-success" target="_blank"><i class="fa fa-eye"></i> Lihat PDF</a>&nbsp;
                                        <a href="<?php echo base_url() ?>internal/assets/assets/produk/putusan/<?php echo $kodekat . "/" . $tahun . "/" . $bulan . "/" . $hproduk['file_upload']; ?>" class="btn btn-primary" target="_blank" download><i class="fa fa-download"></i> Unduh PDF</a>
                                    <?php
                                    } else {
                                        echo 'Tidak ada File';
                                    } ?>
