			...
			<div class="post-content" >
                <div class="row">
                    ...
                    ?>
                        <div class="col-md-2">
                            <a href="">
                                <div class="rounded-circle text-center" style="background-color: #45678d; font-size:16px; margin-bottom:10px; color: #fff; margin-left:20px; padding:13px; width: 50px;height: 50px;">
                                    <i class="<?= $row['icon']; ?> fa-lg"></i><br>
                                </div>
