                ...
                <div class="contact-form" style="background-color:#fff;border-radius:5px;">
                    ...
                    <div class="row">
                        ...
                        <div align="right" style="width:100%">
                            <button class="btn btn-primary" style="width:200px" onclick="get_data('caridetail')"><i class="fa fa-search"></i> CARI</button>
                        </div>
                    </div>
            ...
            <div id="div_cari_cepat" style="display:block;width:100%">
                <div class="contact-form" style="background-color:#fff;border-radius:5px;">
                    <div style="width:100%;border-bottom:3px solid #ffcc00;">
                        <a href="#" style="color:#000;font-size:18px" onclick="tampil_cari('2')"> Pencarian Cepat</a> &nbsp; | &nbsp; <a href="#" class="linka" onclick="tampil_cari('1')"> Pencarian Detail</a>
                    ...
                    <div class="row">
                        <div class="col-10">
                            <div class="group">
                                ...
                                ?>
                                <input type="text" name="tcari" id="tcari" placeholder="masukan kata pencarian" class="form-control" value="<?php echo $t3; ?>" onkeypress="return runScript(event,'1')">

                            </div>
                        </div>

                        <div class="col">
                            <button class="btn btn-primary" style="width:100%" onclick="get_data('cepat')"><i class="fa fa-search"></i> CARI</button>
                        </div>
                    </div>
