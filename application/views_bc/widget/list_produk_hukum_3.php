                        ...
                        <tbody>
                            <tr>
                                ...
                                <td>
                                    ...
                                    ?>
                                        <a href="<?php echo base_url() ?>internal/assets/assets/produk/<?= ($tipe_dokumen == '3') ? 'artikel/' : ''; ?><?php echo $kodekat . "/" . $tahun . "/" . $bulan . "/" . $hproduk['file_upload']; ?>" class="btn btn-success" target="_blank"><i class="fa fa-eye"></i> Lihat PDF</a>&nbsp;
