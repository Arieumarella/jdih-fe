            ...
            <div class="tab-content" id="myTabContent">
                <div class="tab-pane fade show active" role="tabpanel" aria-labelledby="tab1" id="div_produk_hukum">
                    ...
                    <table class="table table-striped table-bordered">
                        ...
                        <tr>
                            <th width="30%">Tempat Peradilan</th>
                            <td width="70%"><?php echo $hproduk['tempat_terbit']; ?></td>
                        </tr>

                        <tr>
                            <th width="30%">Tanggal Dibacakan</th>
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td>
                                    ...
                                    ?>
                                        <a href="<?php echo base_url() ?>internal/assets/assets/produk/<?php echo $kodekat . "/" . $tahun . "/" . $bulan . "/" . $hproduk['file_upload']; ?>" class="btn btn-success" target="_blank"><i class="fa fa-eye"></i> Lihat PDF</a>&nbsp;
                                        <a href="<?php echo base_url() ?>internal/assets/assets/produk/<?php echo $kodekat . "/" . $tahun . "/" . $bulan . "/" . $hproduk['file_upload']; ?>" class="btn btn-primary" target="_blank" download><i class="fa fa-download"></i> Unduh PDF</a>
                                    <?php
                                    } else {
                                        echo 'Tidak ada File';
                                    } ?>
