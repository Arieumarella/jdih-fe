...
class Mdl_home extends CI_Model
{
    ...
    function get_banner_news()
    {
        ...
        //4 Feb 2020
        return $this->db->query("select tipe_dokumen, tanggal,peraturan_id,judul,noperaturan from ppj_peraturan where check_banner='y' order by tgl_modifikasi DESC")->result_array();
